...
const Footer = () => {
  return (
    <div className=" dark:bg-black dark:text-white pt-14">
      <div className="bg-gray-100 dark:bg-dark rounded-t-3xl">
        <section className="container">
          <div className=" grid md:grid-cols-3 py-5">
            {/* company Details */}
            <div className=" py-8 px-4">
              <h1 className="sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex capitalize items-center gap-3 font-serif">
                Rent A car
              </h1>
